    ...
    products: [
      {
        ...
        colourways: [
          ...
          { name: "Cocoa Oak", image: "/images/products/armstrong/aspirations-cocoa-oak.jpg" },
        ],
      },
      {
        name: "Chesterfield",
      ...
      },
      {
        ...
        description:
          "Authentic terrazzo, stone, and concrete visuals including Firenze Terrazzo, Genova Terrazzo, Sandstone, and Granite Black. Waterproof, 5-star acoustic rating for healthcare, education, and aged care.",
        format: "Tile",
        ...
        colourways: [
          ...
          { name: "Concrete", image: "/images/products/armstrong/earthcuts-concrete-grey.jpg" },
          { name: "Firenze Terrazzo", image: "/images/products/armstrong/earthcuts-firenze-terrazzo.jpg" },
          { name: "Genova Terrazzo", image: "/images/products/armstrong/earthcuts-genova-terrazzo.jpg" },
          { name: "Slate", image: "/images/products/armstrong/earthcuts-slate.jpg" },
          { name: "Granite Black", image: "/images/products/armstrong/earthcuts-granite-black.jpg" },
          { name: "Aggregate Miele", image: "/images/products/armstrong/earthcuts-aggregate-miele.jpg" },
        ],
      },
      {
      ...
      },
      {
        ...
        description:
          "The widest plank in the Natural Creations range at 230mm. Authentic Australian timber visuals including Spotted Gum, Blackbutt, Tasmanian Oak, and the Riverland and Valley Oak series. 5.0mm thick with 5-star acoustic rating (42dB).",
        ...
        colourways: [
          ...
          { name: "Riverland Smoke", image: "/images/products/armstrong/xl-riverland-smoke.jpg" },
          { name: "Riverland Ash", image: "/images/products/armstrong/xl-riverland-ash.jpg" },
          { name: "Barnyard Grey", image: "/images/products/armstrong/xl-barnyard-grey.jpg" },
          { name: "Barnwood Ombre", image: "/images/products/armstrong/xl-barnwood-ombre.jpg" },
          { name: "Spotted Gum", image: "/images/products/armstrong/xl-spotted-gum.jpg" },
          { name: "Blackbutt", image: "/images/products/armstrong/xl-blackbutt.jpg" },
          { name: "Tasmanian Oak", image: "/images/products/armstrong/xl-tasmanian-oak.jpg" },
          { name: "Valley Oak Mist", image: "/images/products/armstrong/xl-valley-oak-mist.jpg" },
          { name: "Valley Oak Haze", image: "/images/products/armstrong/xl-valley-oak-haze.jpg" },
          { name: "Oak Tranquil", image: "/images/products/armstrong/xl-oak-tranquil.jpg" },
          { name: "Oak Harmony", image: "/images/products/armstrong/xl-oak-harmony.jpg" },
        ],
      },
      {
        ...
        description:
          "Classical and contemporary wood-grain designs including Ghost Gum, Summer Oak, Limed Oak, and Australian timbers like Sunrise Blackbutt and Country Ironbark. 0.55mm wear layer with 5-star acoustic rating. GreenTag Level A certified.",
        format: "Plank",
        style: "Wood Look",
        image:
        ...
        colourways: [
          ...
          { name: "Limed Oak", image: "/images/products/armstrong/arborart-limed-oak.jpg" },
          { name: "Summer Oak", image: "/images/products/armstrong/arborart-summer-oak.png" },
          { name: "Autumn Barnwood", image: "/images/products/armstrong/arborart-autumn-barnwood.jpg" },
          { name: "Washed Ebony", image: "/images/products/armstrong/arborart-washed-ebony.jpg" },
          { name: "Shadow Oak", image: "/images/products/armstrong/arborart-shadow-oak.jpg" },
          { name: "Victorian Ash", image: "/images/products/armstrong/arborart-victorian-ash.jpg" },
          { name: "Sunset Barnyard Grey", image: "/images/products/armstrong/arborart-sunset-barnyard-grey.jpg" },
          { name: "Twilight Tasmanian Oak", image: "/images/products/armstrong/arborart-twilight-tasmanian-oak.jpg" },
          { name: "Sunrise Blackbutt", image: "/images/products/armstrong/arborart-sunrise-blackbutt.png" },
          { name: "Morning Spotted Gum", image: "/images/products/armstrong/arborart-morning-spotted-gum.png" },
          { name: "Country Ironbark", image: "/images/products/armstrong/arborart-country-ironbark.jpg" },
        ],
      },
    ],
  },
    ...
    products: [
      {
        ...
        colourways: [
          { name: "English Oak Natural", image: "/images/products/tarkett/id-inspiration-english-oak-natural.jpg" },
          { name: "Contemporary Oak Natural", image: "/images/products/tarkett/id-inspiration-contemporary-oak-natural.jpg" },
          { name: "Carrara Grande White", image: "/images/products/tarkett/id-inspiration-carrara-grande-white.jpg" },
          { name: "Belgian Stone Dune", image: "/images/products/tarkett/id-inspiration-belgian-stone-dune.jpg" },
          { name: "Brushed Pine Grey", image: "/images/products/tarkett/id-inspiration-brushed-pine-grey.jpg" },
          { name: "Cast Concrete Cement", image: "/images/products/tarkett/id-inspiration-cast-concrete-cement.jpg" },
        ],
      },
      {
        name: "iD Naturals 70",
        ...
        colourways: [
          { name: "Antik Oak Natural", image: "/images/products/tarkett/id-inspiration-antik-oak-natural.jpg" },
          { name: "Antik Oak Beige", image: "/images/products/tarkett/id-inspiration-antik-oak-beige.jpg" },
          { name: "Cast Concrete Cement", image: "/images/products/tarkett/id-inspiration-cast-concrete-cement.jpg" },
          { name: "Belgian Stone Loam", image: "/images/products/tarkett/id-inspiration-belgian-stone-loam.jpg" },
          { name: "American Walnut Cinnamon", image: "/images/products/tarkett/id-inspiration-american-walnut-cinnamon.jpg" },
          { name: "Century Dawn", image: "/images/products/tarkett/id-inspiration-century-dawn.jpg" },
        ],
      },
      {
        name: "iD Comfort 19",
        ...
        colourways: [
          { name: "Rustic Oak Warm Natural", image: "/images/products/tarkett/id-inspiration-rustic-oak-warm-natural.jpg" },
          { name: "Antik Oak Dark Grey", image: "/images/products/tarkett/id-inspiration-antik-oak-dark-grey.jpg" },
          { name: "Brushed Elm Beige", image: "/images/products/tarkett/id-inspiration-brushed-elm-beige.jpg" },
          { name: "Cast Concrete Cement", image: "/images/products/tarkett/id-inspiration-cast-concrete-cement.jpg" },
          { name: "Belgian Stone Silt", image: "/images/products/tarkett/id-inspiration-belgian-stone-silt.jpg" },
        ],
      },
      {
        ...
        description:
          "Combines design and performance for quick renovation projects. Vinyl planks can be easily combined to create stunning layouts from charred woods to brushed elms.",
        format: "Loose-Lay Plank",
        style: "Wood Look",
        image:
          "/images/products/tarkett/id-inspiration-loose-lay.jpg",
        colourways: [
          { name: "Brushed Elm Natural", image: "/images/products/tarkett/id-inspiration-brushed-elm-natural.jpg" },
          { name: "Brushed Elm Brown", image: "/images/products/tarkett/id-inspiration-brushed-elm-brown.jpg" },
          { name: "Brushed Elm Grege", image: "/images/products/tarkett/id-inspiration-brushed-elm-grege.jpg" },
          { name: "Creek Oak Beige", image: "/images/products/tarkett/id-inspiration-creek-oak-beige.jpg" },
          { name: "Creek Oak Brown", image: "/images/products/tarkett/id-inspiration-creek-oak-brown.jpg" },
          { name: "Charred Wood Black", image: "/images/products/tarkett/id-inspiration-charred-wood-black.jpg" },
        ],
      },
      {
        ...
        description:
          "100+ brilliant designs including planks and tile compositions across wood, stone, and abstract aesthetics. 0.55mm wear layer for moderate to heavy commercial traffic.",
        format: "Plank & Tile",
        style: "Wood, Stone & Abstract",
        image:
        ...
        colourways: [
          { name: "Contemporary Oak Natural", image: "/images/products/tarkett/id-inspiration-contemporary-oak-natural.jpg" },
          { name: "Contemporary Oak Grey", image: "/images/products/tarkett/id-inspiration-contemporary-oak-grey.jpg" },
          { name: "Modern Oak Beige", image: "/images/products/tarkett/id-inspiration-modern-oak-beige.jpg" },
          { name: "Breccia Grey", image: "/images/products/tarkett/id-inspiration-breccia-grey.jpg" },
          { name: "Belgian Stone Silt", image: "/images/products/tarkett/id-inspiration-belgian-stone-silt.jpg" },
          { name: "Brushed Pine Brown", image: "/images/products/tarkett/id-inspiration-brushed-pine-brown.jpg" },
          { name: "American Walnut Marron", image: "/images/products/tarkett/id-inspiration-american-walnut-marron.jpg" },
        ],
      },
      {
        ...
        colourways: [
          { name: "Delicate Oak Almond", image: "/images/products/tarkett/id-inspiration-delicate-oak-almond.jpg" },
          { name: "Delicate Oak Barley", image: "/images/products/tarkett/id-inspiration-delicate-oak-barley.jpg" },
          { name: "Delicate Oak Clay", image: "/images/products/tarkett/id-inspiration-delicate-oak-clay.jpg" },
          { name: "Chatillon Oak Beige", image: "/images/products/tarkett/id-inspiration-chatillon-oak-beige.jpg" },
          { name: "Chatillon Oak Brown", image: "/images/products/tarkett/id-inspiration-chatillon-oak-brown.jpg" },
          { name: "Carrara Grande White", image: "/images/products/tarkett/id-inspiration-carrara-grande-white.jpg" },
        ],
      },
    ],
